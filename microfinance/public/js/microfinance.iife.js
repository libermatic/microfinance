var microfinance = (function (exports) {
'use strict';
    ...
    return _temp = _class = function (_React$Component) {
      ...
      _createClass$2(WithTheme, [{
        ...
        value: function render() {
          ...
          return react.createElement(Component, _extends$3({ theme: theme }, this.props));
        }
      }]);
...
exports['default'] = function (stylesOrCreator, InnerComponent) {
  ...
  return _temp = _class = function (_Component) {
    ...
    _createClass(Jss, [{
      ...
      value: function createState(_ref, _ref2) {
        ...
        if (!staticSheet) {
          ...
          dynamicStyles = (0, _compose2['default'])(staticSheet, (0, jss.getDynamicStyles)(styles));
    ...
    return Jss;
  }(react.Component), _class.displayName = 'Jss(' + displayName + ')', _class.InnerComponent = InnerComponent, _class.contextTypes = _extends({}, _contextTypes2['default'], isThemingEnabled && themeListener.contextTypes), _class.defaultProps = defaultProps, _initialiseProps = function _initialiseProps() {
    var _this2 = this;
...
var logger = browser$2('microfinance:log');

{
  browser$2.enable('microfinance:log');
...
if (!setTask || !clearTask) {
  ...
  // Browsers with MessageChannel, includes WebWorkers
    ...
    channel$2 = new MessageChannel();
    port = channel$2.port2;
    channel$2.port1.onmessage = listener;
...
var isNode$3 = _classof(process$3) == 'process';
var empty = function () { /* empty */ };
var Internal;
...
var USE_NATIVE$1 = !!function () {
  try {
    ...
    return (isNode$3 || typeof PromiseRejectionEvent == 'function') && promise.then(empty) instanceof FakePromise;
  } catch (e) { /* empty */ }
}();
...
var onUnhandled = function (promise) {
  task.call(_global, function () {
    ...
    if (unhandled) {
      ...
      promise._h = isNode$3 || isUnhandled(promise) ? 2 : 1;
...
if (!USE_NATIVE$1) {
  ...
  Internal.prototype = _redefineAll($Promise.prototype, {
    ...
    then: function then(onFulfilled, onRejected) {
      ...
      reaction.domain = isNode$3 ? process$3.domain : undefined;
...
var BillingPeriodList = function (_Component) {
  _inherits(BillingPeriodList, _Component);

  function BillingPeriodList() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, BillingPeriodList);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BillingPeriodList.__proto__ || _Object$getPrototypeOf(BillingPeriodList)).call.apply(_ref, [this].concat(args))), _this), _this.state = { loading: true }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(BillingPeriodList, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      this.fetch_periods();
    }
    ...
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var _props, loan, date, _ref3, periods;
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _props = this.props, loan = _props.loan, date = _props.date;

                this.setState({ loading: true });
                _context.next = 5;
                return frappe.call({
                  method: 'microfinance.microfinance_loan.doctype.loan.loan.get_billing_periods',
                  args: {
                    loan: loan,
              ...
              case 10:
                ...
                frappe.throw(_context.t0.toString());
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          _state$periods = _state.periods,
          periods = _state$periods === undefined ? [] : _state$periods;
      ...
      return react.createElement(
        ...
        react.createElement(
          ...
          react.createElement(
            ...
            react.createElement(
              'th',
              { scope: 'col', className: 'text-right' },
              'Interest'
            )
          )
        ),
        react.createElement(
          ...
          periods.map(function (_ref4) {
            var start_date = _ref4.start_date,
                end_date = _ref4.end_date,
                interest = _ref4.interest,
                as_text = _ref4.as_text;
            return react.createElement(
              'tr',
              {
                key: as_text,
                ...
                onClick: function onClick() {
                  _this2.props.on_select({ period: as_text, interest: interest });
                }
              },
              react.createElement(
                'td',
                null,
                frappe.datetime.str_to_user(start_date) + ' - ' + frappe.datetime.str_to_user(end_date) + ' (' + moment(start_date).format('MMM, YYYY') + ')'
              ),
              react.createElement(
                'td',
                { className: 'text-right' },
                format_currency(interest, frappe.defaults.get_default('currency'), 2)
              )
            );
          })
        )
...
var BillingPeriodList$1 = injectSheet$1(styles)(BillingPeriodList);
...
var NO_OF_PERIODS$1 = 5;

var BillingPeriodDialog = function (_Component) {
  _inherits(BillingPeriodDialog, _Component);

  function BillingPeriodDialog() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, BillingPeriodDialog);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = BillingPeriodDialog.__proto__ || _Object$getPrototypeOf(BillingPeriodDialog)).call.apply(_ref, [this].concat(args))), _this), _this.state = { date: _this.props.date || frappe.datetime.nowdate() }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(BillingPeriodDialog, [{
    key: 'render',
    value: function render() {
      var _this2 = this;
          ...
          react.createElement(
            ...
            react.createElement(
              'button',
              {
                ...
                onClick: function onClick() {
                  _this2.setState({
                    date: frappe.datetime.add_months(_this2.state.date, -NO_OF_PERIODS$1)
                  });
                }
              },
              react.createElement('i', { className: 'octicon octicon-chevron-left' }),
              ' Previous'
            ),
            react.createElement(
              'button',
              {
                className: 'btn btn-info',
                onClick: function onClick() {
                  _this2.setState({ date: frappe.datetime.nowdate() });
                }
              },
              'Current'
            ),
            react.createElement(
              ...
              'Next ',
              react.createElement('i', { className: 'octicon octicon-chevron-right' })
            )
          ),
          react.createElement(
            'button',
            {
              ...
              onClick: function onClick() {
                _this2.props.on_select({});
              }
            },
            'None'
          )
        ),
        react.createElement(BillingPeriodList$1, _extends$1({}, this.props, { date: this.state.date }))
      );
    }
  }]);

  return BillingPeriodDialog;
}(react_1);

var BillingPeriodDialogStyled = injectSheet$1(styles$1)(BillingPeriodDialog);

function BillingPeriodDialog$1 (node, props) {
  reactDom_1(react.createElement(BillingPeriodDialogStyled, props), node);
...
var LoaneeDetails = injectSheet$1(styles$2)(function (_ref) {
  var classes = _ref.classes,
      name = _ref.name,
      department = _ref.department,
      designation = _ref.designation,
      posting = _ref.posting,
      date_of_joining = _ref.date_of_joining,
      date_of_retirement = _ref.date_of_retirement,
      net_salary_amount = _ref.net_salary_amount,
      on_add = _ref.on_add,
  ...
  if (name) {
    return react.createElement(
      ...
      react.createElement(
        'dl',
        null,
        department && react.createElement(
          'div',
          null,
          react.createElement(
            'dt',
        ...
        designation && react.createElement(
          'div',
          null,
          react.createElement(
            'dt',
        ...
        date_of_joining && react.createElement(
          'div',
          null,
          react.createElement(
            'dt',
          ...
          react.createElement(
            'dd',
            null,
            frappe.datetime.str_to_user(date_of_joining)
          )
        ),
        date_of_retirement && react.createElement(
          'div',
          null,
          react.createElement(
            'dt',
          ...
          react.createElement(
            'dd',
            null,
            frappe.datetime.str_to_user(date_of_retirement)
          )
        ),
        net_salary_amount && react.createElement(
          'div',
          null,
          react.createElement(
            'dt',
          ...
          react.createElement(
            'dd',
            null,
            format_currency(net_salary_amount, frappe.defaults.get_default('currency'), 2)
          )
        )
      ),
      react.createElement(
        'button',
        { className: 'btn btn-default btn-xs', onClick: on_edit },
        'Edit'
      )
    );
  }
  return react.createElement(
    ...
    react.createElement(
      'button',
      { className: 'btn btn-xs btn-default', onClick: on_add },
      'Add Details'
    )
  );
});

function LoaneeDetails$1 (node, props) {
  reactDom_1(react.createElement(LoaneeDetails, props), node);
  logger('LoaneeDetails mounted');
}

var styles$3 = {};

var CalculatePrincipal = injectSheet$1(styles$3)(function () {
  return react.createElement(
    'div',
    null,
    'CalculatePrincipal'
...
function CalculatePrincipal$1 (node) {
  reactDom_1(react.createElement(CalculatePrincipal, null), node);
...
var LoadingHandler = function () {
  ...
  _createClass(LoadingHandler, [{
    ...
    value: function remove(item) {
      var idx = this.entities.findIndex(function (x) {
        return x === item;
      });
      if (idx > -1) {
...
exports.BillingPeriodDialog = BillingPeriodDialog$1;
exports.LoaneeDetails = LoaneeDetails$1;
exports.CalculatePrincipal = CalculatePrincipal$1;

return exports;

}({}));
//# sourceMappingURL=microfinance.iife.js.map
